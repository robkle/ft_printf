...
#    Updated: 2020/01/16 15:14:54 by rklein           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/ft_printf.c src/ft_misc.c src/ft_base_print.c \
	  ...
	  src/ft_sdec_flags.c src/ft_uint_flags.c
...
OBJ = ft_printf.o ft_misc.o ft_base_print.o ft_char_print.o ft_double_print.o \
	  ft_e_print.o ft_g_print.o ft_int_print.o ft_uint_print.o ft_sdec_flags.o \
	  ft_uint_flags.o ft_atoi.o ft_isdigit.o ft_putstr.o ft_strclr.o \
	  ft_strcmp.o ft_strdup.o ft_strjoin.o ft_strlen.o ft_strnew.o ft_toupper.o
